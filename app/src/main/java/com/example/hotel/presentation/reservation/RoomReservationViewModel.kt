...
class RoomReservationViewModel(
    ...
    override fun updatePhone(
        ...
        for (elem in result) {
            when (elem) {
                PHONE_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewPhone, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                PHONE_OK_KEY -> ViewCompat.setBackgroundTintList(viewPhone, ColorStateList.valueOf(context.resources.getColor(
    ...
    override fun updateMail(
        ...
        for (elem in result) {
            when (elem) {
                MAIL_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                MAIL_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
    ...
    override fun updateName(
        ...
        for (elem in result) {
            when (elem) {
                FIRST_NAME_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                FIRST_NAME_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
    ...
    override fun updateLastName(
        ...
        for (elem in result) {
            when (elem) {
                LAST_NAME_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                LAST_NAME_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
    ...
    override fun updateDateOfBirth(
        ...
        for (elem in result) {
            when (elem) {
                DATE_OF_BIRTH_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                DATE_OF_BIRTH_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
    ...
    override fun updateCitizenship(
        ...
        for (elem in result) {
            when (elem) {
                CITIZENSHIP_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                CITIZENSHIP_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
    ...
    override fun updatePassportNumber(
        ...
        for (elem in result) {
            when (elem) {
                PASSPORT_NUMBER_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                PASSPORT_NUMBER_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
    ...
    override fun updatePassportExpirationDate(
        ...
        for (elem in result) {
            when (elem) {
                PASSPORT_EXPIRATION_DATE_ERROR_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.error)))
                PASSPORT_EXPIRATION_DATE_OK_KEY -> ViewCompat.setBackgroundTintList(viewMail, ColorStateList.valueOf(context.resources.getColor(
                    R.color.background_color)))
            }
        }
    }
